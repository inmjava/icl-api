package com.copel.picmicroservice.seguranca;

import java.util.Arrays;

import org.docx4j.model.datastorage.XPathEnhancerParser.andExpr_return;
...
public class ConfigSeguranca {
	...
	public static class LdapConfig extends WebSecurityConfigurerAdapter {
		...
		public void configure(WebSecurity web) throws Exception {
			web.ignoring().antMatchers("/monitor**", "/actuator/health/liveness", "/actuator/health/readiness");			
		}
